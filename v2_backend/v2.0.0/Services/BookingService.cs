    ...
    public class BookingService : IBookingService
    {
        ...
        private async Task<BookingModel> MapCreateBookingRequestToBookingModel(CreateBookingRequestDto createBookingRequest)
        {
            ...
            return new BookingModel
            {
                ...
                Dose1CompletedDateTime = DateTime.MinValue,
                Dose2RequestedDateTime = DateTime.MinValue,
                Dose2HospitalUid = "",
                Dose2SlotNumber = 0,
                IsDose2Completed = false,
                Dose2CompletedDateTime = DateTime.MinValue,
                IsVaccinationCompleted = false,
                VaccinationCompletedDateTime = DateTime.MinValue,
