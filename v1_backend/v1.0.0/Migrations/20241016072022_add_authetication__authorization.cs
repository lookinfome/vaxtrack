...
{
    /// <inheritdoc />
    public partial class add_authetication__authorization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slot1Number = table.Column<int>(type: "INTEGER", nullable: false),
                    Slot2Number = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingDetails", x => x.Username);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Uid = table.Column<string>(type: "TEXT", maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "UserVaccinationDetails",
                columns: table => new
                {
                    Username = table.Column<string>(type: "TEXT", nullable: false),
                    VaccinationStatus = table.Column<string>(type: "TEXT", nullable: false),
                    Dose1Date = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Dose2Date = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVaccinationDetails", x => x.Username);
                });
